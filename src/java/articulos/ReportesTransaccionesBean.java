 ...
 * @author Salim
 */
@ManagedBean(name = "reportesTransaccionesBean")
@RequestScoped
public class ReportesTransaccionesBean {

    private int indexSelected;
    private String descripcion;

    public ReportesTransaccionesBean() {
    ...
    public String buscar() throws SQLException {
        ...
        return "reportesTransacciones.xhtml";

    }

    public ResultSet obtenerReportesTransacciones() throws SQLException {
        ...
        if (getDescripcion().equals("") == false) {
            ...
            ResultSet resultSet = DaoReportes.obtenerReportesTransacciones(getIndexSelected());
